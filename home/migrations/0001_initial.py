# Generated by Django 5.1.1 on 2025-10-17 12:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Allotment_access', models.BooleanField(default=False, max_length=100, null=True)),
                ('Expiry_Date', models.DateField(default=datetime.datetime(2026, 10, 17, 12, 18, 23, 207488, tzinfo=datetime.timezone.utc))),
                ('AppPassword', models.CharField(blank=True, default=None, max_length=100, null=True)),
                ('TelegramApi_id', models.CharField(blank=True, max_length=100, null=True)),
                ('TelegramApi_key', models.CharField(blank=True, max_length=100, null=True)),
                ('Mobileno', models.CharField(blank=True, max_length=15, null=True)),
                ('Telegram_session', models.CharField(blank=True, max_length=10000, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Active', models.BooleanField(default=True)),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Client', to=settings.AUTH_USER_MODEL)),
                ('Group', models.ForeignKey(default=None, on_delete=django.db.models.deletion.SET_DEFAULT, to='home.groupdetail')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('Telly', models.CharField(default='False', max_length=100, null=True)),
